...
import {type TxQuery} from "@common/types/tx";
        ...
        const fetchData = async () => {
            ...
            if (periodNum === 1) {
                ...
                for (const t of tx) {
                    ...
                    entry.total += t.amount ?? 0; // adapt to your schema
                }
                ...
                // "All time" fallback
                const summary = { transactions: tx.length, total: tx.reduce((s, t) => s + (t.amount ?? 0), 0) };
                result = [summary];
            }
