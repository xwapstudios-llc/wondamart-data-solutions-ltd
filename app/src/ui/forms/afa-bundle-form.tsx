        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <FormField
                    ...
                    render={({field}) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input className={"bg-primary-foreground dark:bg-transparent"} placeholder="John Doe" {...field} />
                            </FormControl>
                            <FormDescription>As it appears on your Ghana Card</FormDescription>
                            <FormMessage/>
                        </FormItem>
                    )}
                />
                    ...
                    <FormField
                        ...
                        render={({field}) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input className={"bg-primary-foreground dark:bg-transparent"} placeholder="02XXXXXXXX" {...field} />
                                </FormControl>
                                <FormMessage/>
                            </FormItem>
                        )}
                    ...
                    <FormField
                        ...
                        render={({field}) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input className={"bg-primary-foreground dark:bg-transparent"} placeholder="GHA-123456789-0" {...field} />
                                </FormControl>
                                <FormMessage/>
                            </FormItem>
                        )}
                    ...
                    <FormField
                        ...
                        render={({field}) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input className={"bg-primary-foreground dark:bg-transparent"} placeholder="Accra" {...field} />
                                </FormControl>
                                <FormMessage/>
                            </FormItem>
                        )}
                    ...
                    <FormField
                        ...
                        render={({field}) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input className={"bg-primary-foreground dark:bg-transparent"} placeholder="Teacher" {...field} />
                                </FormControl>
                                <FormMessage/>
                            </FormItem>
                        )}
                ...
                <Button type="submit" className="w-full" disabled={loading}>
                    {loading ? <><Loader2Icon className={"animate-spin"}/> Loading</> : "Submit Registration"}
                </Button>
            </form>
        </Form>
    );
