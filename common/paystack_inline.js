(!(function () {
    ...
    ((Inline.prototype.setTransaction = function (t) {
        ...
        (Inline.prototype.loadButtonCSS = function () {
            var t = this;
            cssLoad(config.siteUrl + "public/css/button.min.css").done(
                function () {
                    t.loadedButtonCSS = !0;
                },
            );
                ...
                function (t) {
                    ...
                    if (e && ("string" == typeof e || e instanceof String)) {
                        ...
                        document.getElementById(
                            r.defaults.container,
                        ).style.height = Math.max(Number(n.data), 250) + "px";
                    }
                },
                !1,
            );
            ...
            if (this.defaults.callback || this.form)
                return this.form
                    ...
                    : void (
                          ...
                          this.defaults.callback.call(this, t)
                      );
        }),
            ...
            setup: function (t, e) {
                var n = "paystack" + randomId(),
                    r = {
                        ...
                        payment_request:
                            t.payment_request || t.paymentRequest || "",
                        plan: t.plan || "",
                        quantity: t.quantity || "",
                        coupon: t.coupon || "",
    ...
    function isValid(t) {
        if ((validateInputTypes(t), null == t.key))
            throw new Error(
                "Please provide your public key via the key attribute",
            );
        ...
        if (t.channels && !t.channels.length)
            throw new Error(
                "Channels should be an array of [card, bank] values",
            );
        if (
            t.customButton &&
            null != t.customButton &&
        ...
        if (
            ...
            throw new Error(
                "Please ensure an element with id " +
                    t.container +
                    " is defined",
            );
        return !0;
        ...
        PaystackPop.setup(
            {
                ...
                payment_request: sourceScript.getAttribute(
                ...
                metadata: parseObject(
                    sourceScript.getAttribute("data-metadata"),
                ),
                onClose: parseFunction(
                    sourceScript.getAttribute("data-on-close"),
                ),
                callback: parseFunction(
                    sourceScript.getAttribute("data-callback"),
                ),
                    ...
                    c =
                        ...
                        function (t) {
                            return (
                                t &&
                                -1 <
                                    a.indexOf(Object.prototype.toString.call(t))
                            );
                        };
                ...
                (t.fetch = function (n, i) {
                    return new Promise(function (r, t) {
                        ...
                        ((a.onload = function () {
                            ...
                            a.send(
                                void 0 === e._bodyInit ? null : e._bodyInit,
                            ));
                    });
                }),
                (t.fetch.polyfill = !0));
