...
CREATE TYPE transaction_source AS ENUM ('admin', 'agent', 'store', 'api', 'unknown');
CREATE TABLE transactions (
                              ...
                              source transaction_source NOT NULL DEFAULT 'unknown',
...
CREATE INDEX idx_transactions_api_id ON transactions(api_id);
